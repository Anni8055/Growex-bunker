  ...
  const [conversations, setConversations] = useState<Message[]>([
    {
      ...
      sender: {
        ...
        avatar: 'https://images.unsplash.com/photo-1606041008023-472dfb5e530f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80'
      },
      content: 'We would love to collaborate with you on our new collection.',
    ...
    },
    {
      ...
      sender: {
        ...
        avatar: 'https://images.unsplash.com/photo-1607746882042-944635dfe10e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80'
      },
      content: 'Thank you for your interest in our brand!',
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              ...
              <div className="flex justify-end">
                <div className="bg-primary-500 text-white rounded-lg py-2 px-4 max-w-sm">
                  <p>I'm interested in collaborating with your brand!</p>
              ...
              <div className="flex justify-start">
                <div className="bg-gray-100 dark:bg-gray-800 rounded-lg py-2 px-4 max-w-sm">
                  <p>We would love to collaborate with you on our new collection.</p>
